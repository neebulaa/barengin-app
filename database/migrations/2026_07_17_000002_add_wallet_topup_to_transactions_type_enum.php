...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE transactions MODIFY type ENUM('jastip','trip','jastip_request','split_bill','wallet_topup') NOT NULL");
    }

    public function down(): void
    {
        // Hanya aman jika tidak ada baris bertipe 'wallet_topup'.
