        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm overflow-hidden">
                <div className="p-5 border-b border-neutral-100">
                    <h3 className="font-bold text-neutral-900">Top Rute Terpadat</h3>
                    <p className="text-sm text-neutral-500">Rute dengan partisipan terbanyak.</p>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse min-w-[640px]">
                        <thead>
                            <tr className="bg-[#F4F7FB] text-neutral-500 text-xs font-bold uppercase tracking-wider">
                            ...
                            {topRoutes.length > 0 ? (
                                topRoutes.map((r) => (
                                    <tr key={r.id} className="hover:bg-neutral-50/50 transition">
                                        <td className="py-3.5 px-5 text-sm font-semibold text-neutral-900">{r.name}</td>
                                        ...
                                        <td className="py-3.5 px-5 text-sm font-semibold text-[#0077D3]">{r.joined}/{r.capacity}</td>
                                    </tr>
                                ))
                            ) : (
                                <tr>
...
Analytics.layout = (page) => (
    <AdminLayout title="Dasbor - Home" subtitle="Selamat datang!">
        <div className="mb-6">
            <h1 className="text-2xl font-bold text-neutral-900">Analitik Pergi Bareng</h1>
